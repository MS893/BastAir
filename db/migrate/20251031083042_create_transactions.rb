...
class CreateTransactions < ActiveRecord::Migration[8.0]
  def change
    create_table :transactions do |t|
      ...
      t.boolean :is_checked, default: false, null: false # Permet au trésorier de marquer une transaction comme ayant été vérifiée et rapprochée du relevé bancaire
      ...
      t.datetime :deleted_at                        # date/heure de la suppression
