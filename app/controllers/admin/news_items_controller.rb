...
class Admin::NewsItemsController < Admin::BaseController
  ...
  def create
    ...
    if @news_item.save
      ...
      render :new, status: :unprocessable_entity, alert: "Erreur lors de la création de la consigne."
    end
  end
  ...
  def update
    if @news_item.update(news_item_params)
      ...
      render :edit, status: :unprocessable_entity, alert: "Erreur lors de la mise à jour de la consigne."
    end
  end
