  ...
  class MaintenancesController < ApplicationController
    ...
    def index
      ...
      @forecast_chart_data = avions_scope.map do |avion|
        ...
        if avg_daily_consumption.positive?
      ...
      respond_to do |format|
        ...
        format.pdf do
          render  pdf: "dossier_maintenance_#{@avion.immatriculation}",
                  ...
                  header: { html: { template: 'layouts/_pdf_maintenance_header', layout: false, formats: [:html] },
                            spacing: 10 },
      ...
      if @avion.save
        if changes.any?
          ...
          redirect_to admin_maintenances_path(avion_id: @avion.id),
                      notice: "Potentiels mis à jour pour #{@avion.immatriculation}."
        else
          redirect_to admin_maintenances_path(avion_id: @avion.id),
                      notice: "Aucune modification détectée pour #{@avion.immatriculation}."
        end
      else
        redirect_to admin_maintenances_path(avion_id: @avion.id),
                    alert: "Erreur lors de la mise à jour : #{@avion.errors.full_messages.join(', ')}"
      end
    end
    ...
    def reset_50h
      ...
      redirect_to admin_maintenances_path(avion_id: @avion.id),
                  notice: "Potentiel 50h réinitialisé pour #{@avion.immatriculation}."
    end
    ...
    def reset_100h
      ...
      redirect_to admin_maintenances_path(avion_id: @avion.id),
                  notice: "Potentiel 100h réinitialisé pour #{@avion.immatriculation}."
    end
    ...
    def reset_1000h
      ...
      redirect_to admin_maintenances_path(avion_id: @avion.id),
                  notice: "Potentiel 1000h réinitialisé pour #{@avion.immatriculation}."
    end
    ...
    def reset_moteur
      ...
      redirect_to admin_maintenances_path(avion_id: @avion.id),
                  notice: "Potentiel moteur réinitialisé pour #{@avion.immatriculation}."
    end
    ...
    def notify_grounded
      ...
      Avion.find_each do |avion|
        ...
        next unless unavailability_end_date
        ...
        next unless reservations_to_cancel.any?
      ...
      redirect_to admin_maintenances_path,
                  notice: "#{count} réservations ont été annulées et les pilotes notifiés selon les durées de maintenance prévues."
    end
